...
public class MovieRatingDatabaseGrpcService extends MovieRatingDatabaseService implements Service {
   ...
   */
  public static final io.vertx.grpc.transcoding.TranscodingServiceMethod<examples.movie_rating.MovieId, examples.movie_rating.MovieDetails> GetMovieDetails = io.vertx.grpc.transcoding.TranscodingServiceMethod.server(
    SERVICE_NAME,
    "GetMovieDetails",
    GrpcMessageEncoder.encoder(),
    GrpcMessageDecoder.decoder(examples.movie_rating.MovieId.newBuilder()),
   ...
   */
  public static final io.vertx.grpc.transcoding.TranscodingServiceMethod<examples.movie_rating.MovieRating, examples.movie_rating.Empty> RateMovie = io.vertx.grpc.transcoding.TranscodingServiceMethod.server(
    SERVICE_NAME,
    "RateMovie",
    GrpcMessageEncoder.encoder(),
    GrpcMessageDecoder.decoder(examples.movie_rating.MovieRating.newBuilder()),
    RateMovie_OPTIONS
  );
   ...
   */
  public static final io.vertx.grpc.transcoding.TranscodingServiceMethod<examples.movie_rating.MovieId, examples.movie_rating.MovieRatingDetails> GetMovieRating = io.vertx.grpc.transcoding.TranscodingServiceMethod.server(
    SERVICE_NAME,
    "GetMovieRating",
    GrpcMessageEncoder.encoder(),
    GrpcMessageDecoder.decoder(examples.movie_rating.MovieId.newBuilder()),
...
//    }
    ...
    private class Invoker implements Service {
      ...
      private <Req, Resp> Handler<io.vertx.grpc.server.GrpcServerRequest<Req, Resp>> resolveHandler(ServiceMethod<Req, Resp> serviceMethod) {
        if (GetMovieDetails == serviceMethod) {
          Handler<io.vertx.grpc.server.GrpcServerRequest<examples.movie_rating.MovieId, examples.movie_rating.MovieDetails>> handler = this::handle_getMovieDetails;
          Handler<?> handler2 = handler;
          return (Handler<io.vertx.grpc.server.GrpcServerRequest<Req, Resp>>) handler2;
        }
        if (RateMovie == serviceMethod) {
          Handler<io.vertx.grpc.server.GrpcServerRequest<examples.movie_rating.MovieRating, examples.movie_rating.Empty>> handler = this::handle_rateMovie;
          Handler<?> handler2 = handler;
          return (Handler<io.vertx.grpc.server.GrpcServerRequest<Req, Resp>>) handler2;
        }
        if (GetMovieRating == serviceMethod) {
          Handler<io.vertx.grpc.server.GrpcServerRequest<examples.movie_rating.MovieId, examples.movie_rating.MovieRatingDetails>> handler = this::handle_getMovieRating;
          Handler<?> handler2 = handler;
          return (Handler<io.vertx.grpc.server.GrpcServerRequest<Req, Resp>>) handler2;
        }
        return null;
  ...
  private void handle_getMovieDetails(io.vertx.grpc.server.GrpcServerRequest<examples.movie_rating.MovieId, examples.movie_rating.MovieDetails> request) {
    request.handler(msg -> {
  ...
  private void handle_rateMovie(io.vertx.grpc.server.GrpcServerRequest<examples.movie_rating.MovieRating, examples.movie_rating.Empty> request) {
    request.handler(msg -> {
  ...
  private void handle_getMovieRating(io.vertx.grpc.server.GrpcServerRequest<examples.movie_rating.MovieId, examples.movie_rating.MovieRatingDetails> request) {
    request.handler(msg -> {
