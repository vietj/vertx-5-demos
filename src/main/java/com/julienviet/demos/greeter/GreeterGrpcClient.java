...
public interface GreeterGrpcClient extends GreeterClient {
   ...
   */
  ServiceMethod<com.julienviet.demos.greeter.HelloReply, com.julienviet.demos.greeter.HelloRequest> SayHello = ServiceMethod.client(
    ServiceName.create("examples.grpc", "Greeter"),
    "SayHello",
    GrpcMessageEncoder.encoder(),
    GrpcMessageDecoder.decoder(com.julienviet.demos.greeter.HelloReply.newBuilder()));
...
class GreeterGrpcClientImpl implements GreeterGrpcClient {
  ...
  public Future<com.julienviet.demos.greeter.HelloReply> sayHello(com.julienviet.demos.greeter.HelloRequest request) {
