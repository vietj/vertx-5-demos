...
public class GreeterGrpcService extends GreeterService implements Service {
   ...
   */
  public static final Descriptors.ServiceDescriptor SERVICE_DESCRIPTOR = GreeterOuterClass.getDescriptor().findServiceByName("Greeter");
   ...
   */
  public static final ServiceMethod<com.julienviet.demos.greeter.HelloRequest, com.julienviet.demos.greeter.HelloReply> SayHello = ServiceMethod.server(
    SERVICE_NAME,
    "SayHello",
    GrpcMessageEncoder.encoder(),
    GrpcMessageDecoder.decoder(com.julienviet.demos.greeter.HelloRequest.newBuilder()));
...
//    }
    ...
    private class Invoker implements Service {
      ...
      private <Req, Resp> Handler<io.vertx.grpc.server.GrpcServerRequest<Req, Resp>> resolveHandler(ServiceMethod<Req, Resp> serviceMethod) {
        if (SayHello == serviceMethod) {
          Handler<io.vertx.grpc.server.GrpcServerRequest<com.julienviet.demos.greeter.HelloRequest, com.julienviet.demos.greeter.HelloReply>> handler = this::handle_sayHello;
  ...
  private void handle_sayHello(io.vertx.grpc.server.GrpcServerRequest<com.julienviet.demos.greeter.HelloRequest, com.julienviet.demos.greeter.HelloReply> request) {
    request.handler(msg -> {
