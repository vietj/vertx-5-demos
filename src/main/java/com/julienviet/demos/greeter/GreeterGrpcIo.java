...
import static com.julienviet.demos.greeter.GreeterGrpc.getServiceDescriptor;
...
public final class GreeterGrpcIo {
  ...
  public static final class GreeterStub extends io.grpc.stub.AbstractStub<GreeterStub> implements GreeterClient {
    ...
    public io.vertx.core.Future<com.julienviet.demos.greeter.HelloReply> sayHello(com.julienviet.demos.greeter.HelloRequest request) {
  ...
  private static io.grpc.ServerServiceDefinition serverServiceDefinition(GreeterService service) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
      .addMethod(
        com.julienviet.demos.greeter.GreeterGrpc.getSayHelloMethod(),
        asyncUnaryCall(
                new MethodHandlers<
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          io.vertx.grpcio.server.impl.stub.ServerCalls.<com.julienviet.demos.greeter.HelloRequest, com.julienviet.demos.greeter.HelloReply>oneToOne(
