...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.julienviet.demos.greeter.HelloRequest,
      com.julienviet.demos.greeter.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.julienviet.demos.greeter.HelloRequest.class,
      responseType = com.julienviet.demos.greeter.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.julienviet.demos.greeter.HelloRequest,
      com.julienviet.demos.greeter.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.julienviet.demos.greeter.HelloRequest, com.julienviet.demos.greeter.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.julienviet.demos.greeter.HelloRequest, com.julienviet.demos.greeter.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.julienviet.demos.greeter.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.julienviet.demos.greeter.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(com.julienviet.demos.greeter.HelloRequest request,
        io.grpc.stub.StreamObserver<com.julienviet.demos.greeter.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(com.julienviet.demos.greeter.HelloRequest request,
        io.grpc.stub.StreamObserver<com.julienviet.demos.greeter.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingV2Stub
    ...
    /**
     */
    public com.julienviet.demos.greeter.HelloReply sayHello(com.julienviet.demos.greeter.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.julienviet.demos.greeter.HelloReply> sayHello(
        com.julienviet.demos.greeter.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.julienviet.demos.greeter.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.julienviet.demos.greeter.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.julienviet.demos.greeter.HelloRequest,
              com.julienviet.demos.greeter.HelloReply>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.julienviet.demos.greeter.GreeterOuterClass.getDescriptor();
    }
